...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(width=100, image=true_img, highlightthickness=0, command=self.true_pressed)
        self.true_button.grid(column=0, row=2)
        self.false_button = Button(width=100, image=false_img, highlightthickness=0, command=self.false_pressed)
